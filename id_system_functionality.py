...
def health_table_insert(record: Dict) -> str:
    ...
    if id_has_been_registered:
        ...
        # if duplicate found do nothing
            ...
            logger.info(f'logging unsuccessful insert: {insert_log} in {HEALTH_TABLE_INSERT_LOG}')
...
def health_table_update(updated_by : int, id_to_update : int, records_to_update : Dict[str, Any]) -> str:
    ...
    if id_exists:
        ...
        # if update is unsuccessful
            ...
            logger.info(f'Failed to update table, logging failed update: {update_log} in {HEALTH_TABLE_UPDATE_LOG}')
...
if __name__ == '__main__':
    ...
    initial_health_record_fail = {'id': 1,
                                  'registered_doctor': 'doctor1',
                                  'has_asthma': False,
                                  'has_registered_disability': False}
    ...
    updated_record = {'registered_doctor': 'doctor243',
                      'has_asthma': None,
                      'has_registered_disability': True}
    ...
    updated_record_fail = {'registered_doctor': 'doctor2',
                           'has_diabeties': None,
                           'has_registered_disability': True}
